...
namespace JH.Test
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        {
            GameManager.InputManager.OnMoveInputEvent.OnHeldEvent += CharacterMovement;
            GameManager.InputManager.OnMoveInputEvent.OnReleasedEvent += Stop;
