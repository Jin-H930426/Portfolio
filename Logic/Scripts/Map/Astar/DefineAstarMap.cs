...
namespace JH.Portfolio.Map
{
    ...
    public struct AstarLine
    {
        ...
        public AstarLine(float2 pointOnLine, float2 pointPerpendicularToLine)
        {
    ...
    public class AstarPath
    {
        ...
        // boundary array
        public AstarLine[] turnBoundaries;
        ...
        public AstarPath(float3[] pathArray, float3 startPos, float turnDst, float stoppingDst)
        {
            // Path array
            ...
            for (int i = 0; i < lookPoints.Length; i++)
            {
                ...
                turnBoundaries[i] = new AstarLine(turnBoundaryPoint, previousPoint - dirToCurrentPoint * minTurnDst);
    ...
    public struct SetTileCostJob : IJob
    {
        ...
        [ReadOnlyProperty] public NativeArray<Tile> tiles;
